...
<%
		...
		String sql = "select *, kor+eng+mat, round((kor+eng+mat)/3,1), (select count(*)+1 from examtable as b where (b.kor+b.eng+b.mat) > (a.kor+a.eng+a.mat))" +
		"from examtable as a limit " + calc_key + ", 10;";
...
<%
	...
	if (key_value >= maxKeyValue) {
		...
		out.println("<a href='tenviewDB.jsp?key=" + (key_value) + "'><font size='5'><b>&gt;</b></font></a></p>");
	}
